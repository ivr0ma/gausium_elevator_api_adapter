# Call the Elevator to the Departure Area

> Source: https://developer-us.gs-robot.com/en_US/Elevator%20Control%20System%20Interface%20Protocol%20V1.5/Call%20the%20Elevator%20to%20the%20Departure%20Area
...
> Gausium sends a "Call the Elevator to the Departure Area" request from the WebSocket client to your server. If the call is successful, you should return a "Call Successful" message; if the call fails, you should return a "Call Failed" message.
...
| Name | Type | Remarks |
| --- | --- | --- |
| code | number | Returned information |
